...
import { ArrowLeft, Eye, EyeOff } from 'lucide-react'; // Import icons
...
function RegisterPage() {
  ...
  const handleGoogleSignIn = () => {
    setAlertModal({
      ...
      message: 'Google Sign-Up/Sign-In is not implemented yet!',
      type: 'info'
    });
  };
  ...
  const handleDiscordSignIn = () => {
    setAlertModal({
      open: true,
      title: 'Not Implemented',
      message: 'Discord Sign-Up/Sign-In is not implemented yet!',
      type: 'info'
    });
  };
            ...
            <div className="p-6">
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="space-y-2">
                  <label htmlFor="username" className="block text-sm font-medium text-credigo-light/80">
                ...
                {/* Email Input */}
                <div className="space-y-2">
                  <label htmlFor="email" className="block text-sm font-medium text-credigo-light/80">
                ...
                <div className="flex items-center pt-2">
                  ...
                  <label htmlFor="termsAccepted" className="ml-2 block text-sm text-gray-300">
                    I agree to the{' '}
                    <a href="/terms" target="_blank" rel="noopener noreferrer" className="font-medium text-credigo-accent hover:text-opacity-80 transition-colors">
                ...
                <div className="pt-4">
                  <button
                    ...
                    className={`w-full flex justify-center px-4 py-3 text-sm font-bold text-credigo-dark bg-gradient-to-r from-credigo-accent to-purple-500 border border-transparent rounded-lg shadow-sm hover:shadow-lg hover:shadow-purple-500/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-credigo-input-bg focus:ring-credigo-accent transition-all ${isSubmitDisabled ? 'opacity-50 cursor-not-allowed' : ''}`}
                  >
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-credigo-input-bg text-gray-400">Or sign up with</span>
                </div>
              </div>
              ...
              <p className="mt-8 text-center text-gray-400">
                ...
                <Link to="/login" className="font-medium text-credigo-accent hover:text-opacity-80 transition-colors">
                  Sign in
                </Link>
              </p>
            </div>
